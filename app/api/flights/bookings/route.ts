...
export async function GET(request: NextRequest) {
  try {
    ...
    if (!booking) {
      return NextResponse.json(
        { message: "Flight booking not found or access denied" },
        { status: 404 }
      );
    }
    ...
    return NextResponse.json(
      {
        ...
        data: {
          ...
          bookingData: booking.bookingData, // Complete enriched Amadeus data
    ...
    console.error(`Error retrieving flight booking:`, error);
